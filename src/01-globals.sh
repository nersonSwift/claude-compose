...
CURRENT_SOURCE_SYSTEM_PROMPT_FILES=()  # Collected system prompt file paths (presets/workspaces)
CURRENT_SOURCE_SETTINGS_FILES=()       # Collected settings file paths (presets/workspaces)
